...
namespace Library_Management_System_AD.Admin
{
    public partial class EditBook : System.Web.UI.Page
    {
        ...
        protected void updateBookDetails(object sender, EventArgs e)
        {
            try
            {
            updateBook.UpdateBook(Convert.ToInt32(bookId.Value), txtTitle.Text, txtOverview.Text, txtIsbn.Text, Convert.ToInt32(publisherList.Value), txtPublishedDate.Text, Convert.ToInt32(txtEdition.Text));
